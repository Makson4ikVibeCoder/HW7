...
async function checkReturnTypes(): Promise<void> {
  ...
  const _ok: boolean = deleted.success;
  void _ok;
}
...
// ExtractRouteParams
type P1 = ExtractRouteParams<"/users/:id/posts/:postId">;
const _p1: P1 = { id: "1", postId: "2" };
void _p1;

// @ts-expect-error missing postId
const _p1bad: P1 = { id: "1" };
void _p1bad;

// ResponseOf
type R1 = ResponseOf<ApiSchema, "/users/:id", "GET">;
const _r1: R1 = { id: 1, name: "Alice", email: "a@b.com" };
void _r1;

// MethodsOf
type M1 = MethodsOf<ApiSchema, "/users">;
const _m1: M1 = "GET";
void _m1;
// @ts-expect-error DELETE is not a method of /users
const _m1bad: M1 = "DELETE";
void _m1bad;

// PathsWithMethod
type PP1 = PathsWithMethod<ApiSchema, "POST">;
const _pp1: PP1 = "/users";
void _pp1;
// @ts-expect-error /users/:id does not support POST
const _pp1bad: PP1 = "/users/:id";
void _pp1bad;
